...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks {
    ...
    private class TipsySettingsObserver extends ContentObserver {
        TipsySettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private TipsySettingsObserver mTipsySettingsObserver = new TipsySettingsObserver(mHandler);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTipsySettingsObserver.observe();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mTipsyLogo = mStatusBar.findViewById(R.id.status_bar_logo);
    ...
    public void hideNotificationIconArea(boolean animate) {
        ...
        if (mShowLogo) {
            animateHide(mTipsyLogo, animate, true);
        }
    }
    ...
    public void updateSettings(boolean animate) {
        ...
        if (mTipsyLogo != null) {
            if (logo == null) {
                ...
                mTipsyLogo.setImageDrawable(logo);
                mShowLogo = false;
                return;
            }

            mTipsyLogo.setImageDrawable(logo);
            mTipsyLogo.setColorFilter(mLogoColor, PorterDuff.Mode.MULTIPLY);
        }
        ...
        if (mNotificationIconAreaInner != null) {
            if (mShowLogo) {
                ...
                animateHide(mTipsyLogo, animate, false);
            }
        }
    }
}
