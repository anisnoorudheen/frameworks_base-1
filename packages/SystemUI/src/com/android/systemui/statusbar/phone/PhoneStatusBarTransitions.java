...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public void init() {
        ...
        mTipsyLogo = mView.findViewById(R.id.tipsy_logo);
        mTipsyLogoRight = mView.findViewById(R.id.tipsy_logo_right);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mClock, newAlphaBC),
                    animateTransitionTo(mTipsyLogo, newAlphaBC),
                    animateTransitionTo(mTipsyLogoRight, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mTipsyLogo.setAlpha(newAlphaBC);
            mTipsyLogoRight.setAlpha(newAlphaBC);
        }
    }
}
